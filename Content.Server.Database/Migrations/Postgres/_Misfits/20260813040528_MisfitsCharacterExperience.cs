        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    experience_group = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    total_experience = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
